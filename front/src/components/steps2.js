                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25 thq-body-small">
                      Discover a wide range of tickets for concerts, movies, and
                      more.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28 thq-body-small">
                      Choose the tickets that suit your preferences and budget.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31 thq-body-small">
                      Attend the event and have a great time!
                    </span>
                  </Fragment>
                )}
              </span>
